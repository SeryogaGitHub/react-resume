      ...
      <div className="center">
        <div className="avatar-information">
          ...
          <div className="information">
            <h1>
              Junior React JS, Middle Front-end, Senior HTML-верстальщик
            </h1>
        ...
        <section className="pane wow slideInLeft">
          ...
          <p>
            <span className="gold-text">Постійно використовую:</span> HTML5, CSS3, Pug, SCSS or Less, jQuery, Grid, FlexBox, ReactJS, ES6;<br/>
          ...
          <p>
            ...
            title="3+">OpenCart</span>, <span title="50+">SmartCJ</span>, <span title="1">Django CMS</span>
          </p>

          <p>
            <span className="gold-text">Маю розуміння: </span> <span
            title="Коли працював контет менеджером багато данних вносив">MySql</span>, БЕМ, TypeScript, JSF, Vue.js
          </p>

          <p>
            <span className="gold-text">Зараз в процесі вивчення: ReactJs, React Native, ES6</span>
          </p>

          <p className="gold-text">
            Преоритетним на даний момент є для мене розвиток і практичне використання: ES6, ReactJs, React Native.
          </p>

          <p>
            <span className="gold-text">ReactJs</span> - вже добре розумію що таке компонети(класові, функціональні), роботу з props, житєвий цикл
            компонентів, ref, dispatch і action, reducer (redux), redux-thunk, redux-form, axios, Redirect, setState,
            REST API (get, post, delete, put - мінімум 2 рази кожен використовував в роботі)...
            http://prntscr.com/ow0pzz
          </p>
        ...
        <section className="pane wow slideInLeft">
          ...
          <p>
            <span
              className="gold-text">Готовий до переїзду Тільки після деякого часу співробітництва віддалено</span> або
